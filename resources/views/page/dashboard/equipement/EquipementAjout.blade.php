    ...
    <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-modern main-content-boxed">
      ...
      <main id="main-container" class="">
        ...
        <div class="content">
          ...
          <form class="js-validation-signin" action="{{ route('equipement.action') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form animate__animated ">
                <div class="form-floating mb-4" hidden>
                  ...
                  <div class="form-floating mb-4">
                    ...
                    @enderror
                    <span style="font-size: 12px;color:#868282">Exp:(Chauffe eau)</span>
                  </div>

                <div class="form-floating mb-4">
                  <input type="text" class="form-control" id="login-username" name="marque" placeholder="Enter your username" >
                  <label class="form-label" for="login-username">Entrez La marque de l'appareil</label>
                  @error('marque')
                  <span style="color:rgb(128, 14, 14); font-size: 13px;">{{ $message }}</span> <br>
                  ...
                  <div class="form-floating mb-4">
                    ...
                    <label class="form-label" for="">Photo de l'appareil ou de l'étiquette</label>
                    @error('photo')
                    <span style="color:rgb(128, 14, 14); font-size: 13px;">{{ $message }}</span> <br>
...
<script>
  @if (session('equipement'))
  Swal.fire({
  position: 'top-end',
  icon: 'success',
  title: "{{ session('equipement') }}",
